...
export const PrivacyPolicy = () => {
  return (
    <div className='privacy-policy'>
      ...
      <h2 className='intertitle'>YOU DON'T KNOW!!!</h2>
      <p>
...
export const CryptoContent = (
  <>
    ...
    <p>
      Get started now by creating your very own Crypto Wallet . As always,
      signing up is as easy as signing over all your personal data, firstborn
      child, and Miranda Rights to Purse. And you can be sure that your Crypto
      Wallet is protected by the same security blocks that keep your Purse
      Checking and Savings Accounts locked down tight, so you never have to
