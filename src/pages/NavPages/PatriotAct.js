    ...
    >
      <Container className={classes.heading}>
        ...
        <p>
          ...
          signed the <span className={classes.color}>U</span>niting and{' '}
          <span className={classes.color}>S</span>trengthening{' '}
          <span className={classes.color}>A</span>merica by{' '}
          <span className={classes.color}>P</span>
          roviding <span className={classes.color}>A</span>ppropriate{' '}
          <span className={classes.color}>T</span>ools{' '}
          <span className={classes.color}>R</span>equired to{' '}
          <span className={classes.color}>I</span>ntercept and{' '}
          <span className={classes.color}>O</span>bstruct{' '}
          <span className={classes.color}>T</span>errorism (
          <span className={classes.color}>USA PATRIOT</span>) Act into law.
          ...
          undead successor, the <span className={classes.color}>U</span>niting
          and <span className={classes.color}>S</span>trengthening{' '}
          <span className={classes.color}>A</span>merica by{' '}
          <span className={classes.color}>F</span>ulfilling{' '}
          <span className={classes.color}>R</span>ights and{' '}
          <span className={classes.color}>E</span>nsuring{' '}
          <span className={classes.color}>E</span>ffective{' '}
          <span className={classes.color}>D</span>iscipline{' '}
          <span className={classes.color}>O</span>ver{' '}
          <span className={classes.color}>M</span>onitoring (
          <span className={classes.color}>USA FREEDOM</span>) Act,{' '}
          <a
